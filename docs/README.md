...
| 幹事・進行ツール群・一覧（LP `#tools`） | `public/app-tools/{slug}/`, `src/components/landing/ToolsGrid.tsx` | requirements §4.6 · design §8b |
...
**ことほぎ**は、結婚式・パーティーの幹事・司会が、特別な機材なしで余興（交流ビンゴ・クイズ・リアルタイムアンケート）を実施できる Web アプリ群と、その紹介用ランディングページです。
